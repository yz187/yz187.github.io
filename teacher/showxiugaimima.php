...
if(isset($_POST['keyword'])){
	...
	$where="where 论文题目 like '%$keyword%'";
}
if(isset($_POST['keyword'])){
	$keyword=$_POST['keyword'];
	$keyword=safeHandle($link,$keyword);
	$where="where 选题学生 like '%$keyword%'";
}
if(isset($_POST['keyword'])){
	$keyword=$_POST['keyword'];
	$keyword=safeHandle($link,$keyword);
...
$page_size = 4;
$result=mysqli_query($link,'select count(*) from teacher');
