...
<div class="box">
	...
	<tr><th>论文题目：</th><td><input type="text" name="论文题目"/></td></tr>
	<tr><th>上传教师：</th><td><input type="text" name="上传教师" /></td></tr>
	<tr><th>选题学生：</th><td><input type="text" name="选题学生" /></td></tr>
	<tr><th>上传时间：</th><td><input type="text" name="上传时间" /></td></tr>
