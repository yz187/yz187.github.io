...
$sql = 'select *from manage_s'; 
$manage_s=fetchAll($link,$sql);
...
$sql="select * from manage_s $where";

$page_size = 4;
$result=mysqli_query($link,'select count(*) from manage_s');
