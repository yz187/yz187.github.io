...
<table background="../images/bg.jpg" width="1280" height="100" cellpadding="0" cellspacing="0" class="mainbar" align="center">
  ...
  <tr>
    <td height="25" class="leftMenu" >&nbsp;&nbsp;<img src="images/CreateLeads.gif" width="16" height="16">&nbsp;&nbsp;<a href="./mysqli_empAdd.php" target="self">添加学生&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
  </tr>
...
&nbsp;</td>
  ...
  <tr>
    <td colspan="6"><font color="red" size="3"> 论文管理系统：管理员管理>>管理学生</font>&nbsp;</td>
  </tr>
  <tr>
    <th width="5%">ID</th><th>学号</th><th>姓名</th><th>院系</th><th width="20%">操作</th>
			</tr>
			<?php  if(!empty($manage_s)) { ?>
			<?php foreach($manage_s as $row){ ?>
			<tr>
				 <td><?php echo $row['ID']; ?></td>
				 <td><?php echo $row['学号']; ?></td>
				 <td><?php echo $row['姓名']; ?></td>
				 <td><?php echo $row['院系']; ?></td>
