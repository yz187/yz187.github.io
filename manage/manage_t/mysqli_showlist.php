...
$sql = 'select *from manage_t'; 
$manage_t=fetchAll($link,$sql);
...
$sql="select * from manage_t $where";

$page_size = 4;
$result=mysqli_query($link,'select count(*) from manage_t');
