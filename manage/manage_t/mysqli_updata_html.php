...
<div class="box">
	...
	<tr><th>工号：</th><td><input type="text" name="工号" value="<?php echo $manage_t['工号'];?>"/></td></tr>
	<tr><th>姓名：</th><td><input type="text" name="姓名" value="<?php echo $manage_t['姓名'];?>"/></td></tr>
	<tr><th>所属院系：</th><td><input type="text" name="所属院系" value="<?php echo $manage_t['所属院系'];?>"/></td></tr>
