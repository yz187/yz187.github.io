...
<html>
 ...
 <title>管理员登录</title>
 <style>
 .body{background-color: #f0f8fb;background-image: url(../images/1.jpg);}
 body{background-color:#eee;margin:0;padding:0;}
.reg{width:550px;margin:15px;padding:20px;border:0px solid #ccc;height: 300px;}
...
.error-box ul{margin: 10px;padding-left: 25px;}
 ...
 <form method="post">
 <table class="reg">
 <tr><td class="title" colspan="2"><h2>管理员登录</h2></td></tr>
 <tr><th>用户名：</th><td><input type="text" name="username"/></td></tr>
 <tr><th>密&nbsp;&nbsp;码：</th><td><input type="password" name="password"/></td></tr>
  <tr><th>验证码：</th><td><input type="text" name="captcha" />
				<img src="code.php" alt="" id="code_img"/>  
				<a href="#" id="change">看不清，换一张</a></td></tr>
