...
.box{width:400px;margin:15px;padding:20px;border:0px solid #ccc;background-color:#f7fefc;}
...
.box .welcome span{color: #ff0000;}
 ...
 <body>
 <div class="box">
 	<div class="title">管理员管理中心</div>
 	<?php if($login): ?>
 		<div class="welcome">“<span><?php echo $userinfo['username'];?>
 		</span>”您好，欢迎来到管理员管理中心！<a href="?action=logout">退出</a></div>
 	<?php else:?>
