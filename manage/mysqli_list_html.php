...
<table background="../images/bg.jpg" width="1280" height="100" cellpadding="0" cellspacing="0" class="mainbar" align="center">
  ...
  <tr>
    <td height="25" class="leftMenu" >&nbsp;&nbsp;<img src="../images/CreateLeads.gif" width="16" height="16">&nbsp;&nbsp;<a href="./mysqli_empAdd.php" target="self">添加管理员&nbsp;&nbsp;</a></td>
  </tr>
  <tr>
     <td height="25" class="leftMenu">&nbsp;&nbsp;<img src="../images/CreateLeads.gif" width="16" height="16">&nbsp;&nbsp;<a href="./manage_s/mysqli_showlist.php" target="_self">管理学生&nbsp;&nbsp;&nbsp;&nbsp;</a></td>

  </tr>
  <tr>
     <td height="25" class="leftMenu">&nbsp;&nbsp;<img src="../images/CreateLeads.gif" width="16" height="16">&nbsp;&nbsp;<a href="./manage_t/mysqli_showlist.php" target="_self">管理教师&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
...
&nbsp;</td>
  ...
  <tr>
    <td colspan="6"><font color="red" size="3"> 论文管理系统：管理员管理</font>&nbsp;</td>
  </tr>
  <tr>
    <th width="5%">ID</th><th>姓名</th><th>性别</th><th>邮箱</th><th width="20%">操作</th>
			</tr>
			<?php  if(!empty($manage)) { ?>
